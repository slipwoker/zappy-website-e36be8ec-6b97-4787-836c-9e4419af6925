...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (animatedElements.length > 0) {
        ...
        if (!document.getElementById('scroll-animations-style')) {
            ...
            style.textContent = `
                .fade-in-init, [data-animate] {
                    opacity: 0;
                    transform: translateY(20px);
                    transition: opacity 0.6s ease-out, transform 0.6s ease-out;
                }
                .fade-in-init.visible, [data-animate].visible {
                    opacity: 1;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e36be8ec-6b97-4787-836c-9e4419af6925',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e36be8ec-6b97-4787-836c-9e4419af6925';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e36be8ec-6b97-4787-836c-9e4419af6925';
